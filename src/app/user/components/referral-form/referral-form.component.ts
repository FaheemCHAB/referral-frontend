...
<!-- <div class="bg-gray-900 text-center py-4 lg:px-4">
  <a href="https://aitrichacademy.com/" target="_blank" class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
    <span class="flex rounded-full bg-indigo-500 uppercase px-2 py-1 text-xs font-bold mr-3">Info</span> 
    <span class="font-semibold mr-2 text-left flex-auto font-mono">Click here to know more about us</span>
        ...
        <div class="md:flex w-full">
          ...
          <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div class="text-center mb-10">
              <h1 class="font-bold text-3xl text-gray-900">Referral Form</h1>
              <!-- <h1>Referral Form</h1> -->
            </div>
            <div>
              <form (ngSubmit)="onSubmit()">
                ...
                <div class="flex -mx-3">
                  <div class="w-1/2 px-3 mb-5">
                    <!-- <label for="" class="text-xs font-semibold px-1">Mobile</label> -->
                    <div class="flex">
                      <div
                        class="pl-1 text-center pointer-events-none flex items-center justify-center"
                      >
                        <i
...
>
                    ...
                    <div class="flex">
                      ...
                      <input
                        ...
                        [(ngModel)]="formData.age"
                         (input)="onAgeInput()"
                      />
                      <p *ngIf="ageError" class="text-red-500">{{ ageError }}</p>
                    </div>
                  </div>
                  <div class="w-1/2 px-3 mb-5">
                    <!-- <label for="" class="text-xs font-semibold px-1">Qualification</label> -->
                    <div class="flex">
                      <div
                        class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"
                      >
  ...
  <a
    ...
    target="_blank"
    class="p-2 bg-indigo-800 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex justify-center"
    role="alert"
  >
    <span class="font-semibold mr-2 text-left flex-auto font-mono">
      Know more about Aitrich Academy
    </span>
    <svg
    ...
    >
      ...
      />
              ...
              <div class="flex justify-center items-center space-x-4 mb-4 text-center">
                <a
...
export class ReferralFormComponent {
  ...
  ngOnInit() {
    this.route.queryParams.subscribe((params) => {
      this.formData.referredBy = params["ref"] || "";
    });
  }
